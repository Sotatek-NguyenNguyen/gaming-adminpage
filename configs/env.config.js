...
const SOLLET_ENV =
  process.env.NEXT_PUBLIC_SOLLET_ENV || WalletAdapterNetwork.Devnet;
...
const ISOLA_TOKEN_NAME = process.env.NEXT_PUBLIC_ISOLA_TOKEN_NAME;
const SOLLET_ENV2 = (process.env.REACT_APP_NETWORK_CLUSTER) || 'testnest';
